...
import { isValidId, isValidStrings, isEmptyObject, isValidObject, isPropertyOf } from "../util/validator";
import { 
    BadRequestError, 
...
export class UserService {
    ...
    async addNewUser(newUser: User): Promise<User> {
        ...
        try {
            ...
            newUser.username = 'Staff'; // all new registers have 'staff' role by default
