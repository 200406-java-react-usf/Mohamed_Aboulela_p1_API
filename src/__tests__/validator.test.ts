...
//     //     // Act
//     //     let result1 = isValidObject(new Reimbursement(1, 'title', 'body', 1));
...
//     //     // Act
//     //     let result1 = isValidObject(new Reimbursement(0, 'title', 'body', 1), 'id');
...
//     //     // Act
//     //     let result1 = isValidObject(new Reimbursement(1, '', 'body', 1));
...
//     //     // Act
//     //     let result1 = isValidObject(new Reimbursement(1, '', 'body', 1), 'id');
